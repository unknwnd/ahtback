...
async function AnimalHelperToken_init(owner: Address, content: Cell, walletCode: Cell, teamVestingContract: Address, tokenSaleContract: Address) {
...
export class AnimalHelperToken implements Contract {
    ...
    static async init(owner: Address, content: Cell, walletCode: Cell, teamVestingContract: Address, tokenSaleContract: Address) {
        return await AnimalHelperToken_init(owner, content, walletCode, teamVestingContract, tokenSaleContract);
    }
    
    static async fromInit(owner: Address, content: Cell, walletCode: Cell, teamVestingContract: Address, tokenSaleContract: Address) {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "mint_initial" | UpdateContentMessage | Deploy | "get_jetton_data" | GetWalletAddress) {
