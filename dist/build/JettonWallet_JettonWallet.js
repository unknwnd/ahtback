...
exports.JettonWallet = exports.JettonWallet_getterMapping = exports.JettonWallet_errors_backward = exports.JettonWallet_errors = void 0;
...
async function JettonWallet_init(jettonMaster, owner) {
...
exports.JettonWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
class JettonWallet {
    static async init(jettonMaster, owner) {
        return await JettonWallet_init(jettonMaster, owner);
    }
    static async fromInit(jettonMaster, owner) {
    ...
    constructor(address, init) {
        this.abi = {
            ...
            errors: exports.JettonWallet_errors,
        };
    ...
    async send(provider, via, args, message) {
        let body = null;
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'GetWalletDataMessage') {
            body = (0, core_1.beginCell)().store(storeGetWalletDataMessage(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'InternalTransferMessage') {
            body = (0, core_1.beginCell)().store(storeInternalTransferMessage(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'TransferMessage') {
            body = (0, core_1.beginCell)().store(storeTransferMessage(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'BurnMessage') {
            body = (0, core_1.beginCell)().store(storeBurnMessage(message)).endCell();
        }
        if (body === null) {
...
JettonWallet.storageReserve = 0n;
JettonWallet.errors = exports.JettonWallet_errors_backward;
JettonWallet.opcodes = JettonWallet_opcodes;
